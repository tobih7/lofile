...
def execute_script(script: bytes):
    ...
    try:
        exec(script, g) # TODO: first compile() then exec, so errors can be reported even before executing: sth. like opening file: and the errors like file is empty, but script is invalid
    except:
        ... # TODO #
