    ...
    def _askfile(self):
        while True:
            try:
                ...
                out(
                    "\x1b[B  \x1b[91mPermission to the file was denied!\x1b[0m\x1b[2A\r\x1b[K",
                    flush=True,
                )
            except OSError as exc:
                out(
                    f"\x1b[B  \x1b[91mThe path is invalid!\n\x1b[2C\x1b[90mError {exc.errno}: {exc.strerror}\x1b[0m\x1b[3A\r\x1b[K",
                    flush=True,
                )
