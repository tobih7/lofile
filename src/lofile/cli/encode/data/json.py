...
class JSON:
    ...
    def _data_json(self, /, editing=False, data=None):
        ...
        method = Selector(("file", "notepad input", "console input"), "Data Source:", print_result=False).pos if not editing else 1 # 1 = notepad_input
        ...
        while True:
            ...
            try:
                ...
                err = f"Error in line {exc.lineno}: \x1b[91m{exc.msg}!\x1b[0m\n\n" \
        ...
        self.dataorigin = ((DataOrigin.File, originpath), (DataOrigin.NotepadInput,), (DataOrigin.ConsoleInput,))[method]
        return data
